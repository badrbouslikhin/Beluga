...
This archive contains the hardware files (schematics, bill of materials and fabrication files (Gerbers, stackup report and NCDrill files)) for the STM32F429ZI based embedded Linux board.
This board is a scholar project developed at French engineering school INSA Lyon, department of electrical engineering.
...
For any further information or query, please contact bouslikhin.badr@gmail.com